...
while (true) {
    ...
    Общая стоимость проекта ${price.finalPrice}`);
    if (questionClient) {
        break;
    } else {
...
function calculationPrice() {
    let finalPrice = 0;
    while (true) {
        type = prompt(`Какой тип сайта вы желаете? 
            ...
            4. ${objectArraysKeys.arrTypeKeys[3]} 
                                            Введит название или номер`, "Визитка")
            ;
        if (type <= objectArraysKeys.arrTypeKeys.length && type >= 1 && type.Object != String) {
            finalPrice += calculationSite.design[objectArraysKeys.arrTypeKeys[type - 1]];
            price.clientType = objectArraysKeys.arrTypeKeys[type];
            alert(`Вы выбрали тип ${objectArraysKeys.arrTypeKeys[type]} 
                    Стоимость данной услуги составляет: ${calculationSite.typeSite[objectArraysKeys.arrTypeKeys[type - 1]]}
        ...
        while (true) {
            design = prompt(`Какой дизайн сайта вы желаете? 
                ...
                4. ${objectArraysKeys.arrDesignKeys[3]} 
                                                Введит название или номер`, "figma")
                ;
            if (design <= objectArraysKeys.arrDesignKeys.length && design >= 1 && design.Object != String) {
                finalPrice += calculationSite.design[objectArraysKeys.arrDesignKeys[design - 1]];
                price.clientDesign = objectArraysKeys.arrDesignKeys[design];
                alert(`Вы выбрали дизайн ${objectArraysKeys.arrDesignKeys[design]} 
                        Стоимость данной услуги составляет: ${calculationSite.design[objectArraysKeys.arrDesignKeys[design - 1]]}
    ...
    while (true) {
        adaptive = prompt(`Какой адаптив сайта вы желаете? 
            ...
            4. ${objectArraysKeys.arrAdaptiveKeys[3]} 
                                            Введит название или номер`, "с адаптивом")
            ;
        if (adaptive <= objectArraysKeys.arrAdaptiveKeys.length && adaptive >= 1 && adaptive.Object != String) {
            ...
            alert(`Вы выбрали адаптив ${objectArraysKeys.arrAdaptiveKeys[adaptive]} 
                    Стоимость данной услуги составляет: ${calculationSite.adaptive[objectArraysKeys.arrAdaptiveKeys[adaptive - 1]]}
                    На данный момент общая сумма проекта: ${finalPrice}
                    Перейдём к итогам`);
